---
# Contenu de la page d'accueil (français). Modifiez le texte ici — la mise en
# page, les couleurs et les icônes restent dans les composants.
#
# Notes :
# - "\n" dans une chaîne entre guillemets force un retour à la ligne
#   (utilisé dans les titres des cartes).
# - Les champs « Encircled » sont entourés du cercle orange dessiné à la main.
# - hero.cards doit contenir exactement 5 entrées, why.cards exactement 3
